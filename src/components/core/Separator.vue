...
<template>
  ...
  <div
    ...
    aria-hidden="true"
    :class="[spacingClass, 'border-l border-base-dim self-stretch min-h-4']"
  />
  ...
  >
    <div class="flex-1 border-t border-base-dim" />
    <span class="type-caption-r text-base-dim whitespace-nowrap">{{ label }}</span>
    <div class="flex-1 border-t border-base-dim" />
  </div>
  ...
  <div
    ...
    :class="spacingClass"
  >
    <div class="border-t border-base-dim w-full" />
  </div>
</template>
