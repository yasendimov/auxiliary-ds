...
const routes = [
  {
    ...
    children: [
      ...
      // 08 Gallery
      {
        path: 'brand/gallery/theme',
        name: 'gallery-theme',
        component: () => import('../docs/pages/gallery/ThemePage.vue')
      },
      {
        path: 'brand/gallery/marketing',
        name: 'gallery-marketing',
        component: () => import('../docs/pages/gallery/MarketingPage.vue')
      },
      {
        path: 'brand/gallery/applications',
        name: 'gallery-applications',
        component: () => import('../docs/pages/gallery/ApplicationsPage.vue')
      },
      {
        path: 'brand/gallery/operations',
        name: 'gallery-operations',
        component: () => import('../docs/pages/gallery/OperationsPage.vue')
      },
      {
        path: 'brand/gallery/special',
        name: 'gallery-special',
        component: () => import('../docs/pages/gallery/SpecialPage.vue')
      },
