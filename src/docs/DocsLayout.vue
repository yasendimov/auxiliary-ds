        ...
        <template v-for="section in navSections" :key="section.label">
          ...
          <div v-for="item in section.items" :key="item.number">
            ...
            <router-link
              ...
              :class="isItemActive(item) ? 'text-content-high' : 'text-content-low hover:text-content-high'"
              @click.native="toggleItem(item)"
            >
              <span class="type-overline font-mono tabular-nums w-4 shrink-0">{{ item.number }}</span>
              ...
              <div class="overflow-hidden">
                <div class="pb-1">
                  <router-link
                    ...
                    :class="isChildActive(item, child) ? 'text-content-high' : 'text-content-low hover:text-content-high'"
                  >
                    {{ child.name }}
                  </router-link>
                </div>
