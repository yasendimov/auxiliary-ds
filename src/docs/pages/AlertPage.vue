<script setup>
import { ref } from 'vue'
import { AuxAlert, AuxButton } from '../../components'
...
<template>
  <div>
    ...
    <section class="px-8 lg:px-16 pt-24 pb-16">
      ...
      <h1 class="type-display-sb text-content-high mt-4">Alert</h1>
      ...
      <div class="grid grid-cols-1 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-4">
          <div class="max-w-lg flex flex-col gap-3">
            <span class="type-overline text-content-dim">alarm</span>
            <AuxAlert
              variant="alarm"
            ...
            <span class="type-overline text-content-dim mt-4">warning</span>
            <AuxAlert
              variant="warning"
            ...
            <span class="type-overline text-content-dim mt-4">caution</span>
            <AuxAlert
              variant="caution"
            ...
            <span class="type-overline text-content-dim mt-4">ok</span>
            <AuxAlert
              variant="ok"
            ...
            <span class="type-overline text-content-dim mt-4">info</span>
            <AuxAlert
              variant="info"
    ...
    <section class="px-8 lg:px-16 mt-24">
      ...
      <div class="grid grid-cols-3 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">alarm</span>
          <AuxAlert variant="alarm" title="Connection lost" />
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">ok</span>
          <AuxAlert variant="ok" title="Calibration complete" />
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">info</span>
          <AuxAlert variant="info" title="System update scheduled" />
        </div>
      </div>
    </section>
    ...
    <section class="px-8 lg:px-16 mt-24">
      ...
      <div class="grid grid-cols-2 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">warning</span>
          <div class="max-w-sm">
            <AuxAlert
              variant="warning"
        ...
        <div class="border-b border-r border-line p-8">
          <div class="max-w-lg flex flex-col gap-3">
            ...
            <div v-if="!showAlarm || !showOk || !showInfo" class="mt-2">
              <AuxButton variant="ghost" size="sm" @click="resetDismissible">Reset</AuxButton>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="px-8 lg:px-16 mt-24">
      ...
      <div class="grid grid-cols-2 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">button action</span>
          <div class="max-w-sm">
            <AuxAlert
              variant="warning"
            ...
            >
              <AuxButton variant="ghost" size="sm">View details</AuxButton>
            </AuxAlert>
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">link action</span>
          <div class="max-w-sm">
            <AuxAlert
              variant="info"
            ...
            >
              <a
                href="#"
                class="type-caption-m text-info-content hover:text-info-hover transition-colors duration-fast"
              >
                Learn more
              </a>
            </AuxAlert>
