<script setup>
import { ref } from 'vue'
import { AuxTextarea } from '../../components'
...
<template>
  <div>
    ...
    <section class="px-8 lg:px-16 pt-24 pb-16">
      ...
      <h1 class="type-display-sb text-content-high mt-4">Textarea</h1>
    ...
    <section class="px-8 lg:px-16 mt-24">
      ...
      <div class="grid grid-cols-2 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">default (empty)</span>
          <div class="max-w-sm">
            <AuxTextarea v-model="stateEmpty" label="Notes" placeholder="Enter notes..." />
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">with value</span>
          <div class="max-w-sm">
            <AuxTextarea v-model="stateWithValue" label="Notes" />
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">disabled</span>
          <div class="max-w-sm">
            <AuxTextarea v-model="stateDisabled" label="Notes" disabled />
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
    ...
    <section class="px-8 lg:px-16 mt-24">
      ...
      <div class="grid grid-cols-3 border-t border-l border-line">
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">none</span>
          <div>
            <AuxTextarea v-model="resizeNone" label="Fixed" resize="none" :rows="3" />
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">vertical (default)</span>
          <div>
            <AuxTextarea v-model="resizeVertical" label="Resizable" resize="vertical" :rows="3" />
          </div>
        </div>
        <div class="border-b border-r border-line p-8 flex flex-col gap-3">
          <span class="type-overline text-content-dim">auto</span>
          <div>
            <AuxTextarea
              v-model="resizeAuto"
              label="Auto-grow"
    ...
    <section class="px-8 lg:px-16 mt-24 pb-24">
      ...
      <div class="grid grid-cols-1 border-t border-l border-line">
        <div class="border-b border-r border-line p-8">
          <div class="max-w-lg rounded-panel bg-surface-1 p-6">
            <h3 class="type-section-sb text-content-high mb-4">New Mission</h3>
            <AuxTextarea
